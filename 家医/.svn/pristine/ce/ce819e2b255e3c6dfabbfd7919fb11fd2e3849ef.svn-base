...
wx.getSystemInfo({
  success: function (res) {
    canvasw = res.windowWidth - res.windowWidth*0.26;
    canvash = res.windowHeight - res.windowHeight * 0.2;
  },
}),
Page({
  data: {
  ...
  linkTeamDetailTap: function (e) {
    console.log(e)
    wx.navigateTo({
      url: '../../info/doctors/teamdetail/teamdetail?id=' + e.currentTarget.dataset.id
    })
  },
  ...
  confirmDialogTap: function () {
    var _this = this;
    wx.redirectTo({
      url: '../../webviewlink/webviewlink?url=sign&tid=' + _this.data.teamId + '&aid=' + _this.data.aId
    })
  },
  //签约
  ...
  linkAddMemberTap: function () {
    ...
    wx.redirectTo({
      url: '../../info/family/add/add?backUrl=../../../sign/confirm/confirm&tid=' + this.data.options.tid + '&aid=' + aId,
    })
  },
