// page/appointment/page/appointment/appointment.js
const app = getApp()
...
Page({
    ...
    onLoad: function (options) {
        ...
        wx.getSystemInfo({
            success: function (res) {
                var windeoHeight = res.windowHeight;
                var query= wx.createSelectorQuery();
                var searchHeight;
                query.selectAll('.search').boundingClientRect().exec(function (res) {
                    searchHeight = res[0][0].height;
                    _this.setData({
                        height: windeoHeight - searchHeight
                    })
    ...
    getList: function (current) {
        ...
        if (params.pageNo) {
            wx.request({
            //app.request({ // 实际对接把wx.request 改为app.request
                url: 'https://www.easy-mock.com/mock/5c3d80bce7d9820ff0eaac30/example/selectorglist',
                header: {
