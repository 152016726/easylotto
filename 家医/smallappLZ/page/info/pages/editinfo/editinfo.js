...
Page({
  ...
  save: function () {
    ...
    if (ifSelectAddress && !_this.data.addressTip && !_this.data.nameTip && !_this.data.phoneTip && !_this.data.idCardTip && ((!userInfo.id && !_this.data.codeTip) || userInfo.id)) {
      ...
      console.log()
      if (!userInfo.id) { params.code = _this.data.code }
      app.request({
        ...
        success: function (res) {
          ...
          if (res.code == 1) {
            ...
            wx.setStorageSync("userInfo",  res.obj)
            wx.showToast({
              title: '保存成功',
              icon: 'success',
              duration: 2000,
            ...
            success: function (res) {
              if (res.code == 1) {
                ...
                //wx.setStorage({
                  ...
                  //data: userInfo
                //})
                userInfo.idCardNum = util.secretData(userInfo.idCard, 'idCard');
                userInfo.mobile = util.secretData(userInfo.userMobile, 'phone');
