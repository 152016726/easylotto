...
Page({
    ...
    wx.getStorage({
      ...
      success: function (res) {
        ...
        if (res.data.id) {
          ...
          wx.redirectTo({
            url: '/page/info/pages/editinfo/editinfo',
          })
        }
      }
    })
  ...
  linkAddresslistTap: function () {
    wx.navigateTo({
      url: '/page/info/pages/address/list/list?backUrl=../../../sign/selectaddress/selectaddress&tid=' + this.data.teamId,
    })

  },
  addAddressTap: function () {
    wx.navigateTo({
      url: '/page/info/pages/address/add/add?backUrl=../../../sign/selectaddress/selectaddress&tid=' + this.data.teamId,
    })
